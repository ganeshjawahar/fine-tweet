...
cmd:option('-rep', '../../auxillary/representations/ne/doc2vec/', '')
cmd:option('-lr', 0.01, '')
...
params.full_rep_lines = tds.hash()
for line in io.lines(params.rep..'train.tsv') do
	params.full_rep_lines[#params.full_rep_lines + 1] = line
end
params.num_folds = 4
...
print('data='..params.rep..';test_score='..params.best_test_score..';lr='..params.lr..';bsize='..params.batch_size..';dropout='..params.dropout_p..';epochs='..params.num_epochs)
local res = ''
for i = 1, params.max_len do
