	...
	for line in io.lines(data_file) do
		...
		if #dcontent[1] > 0 then
			...
			if params.cand2index[neg_content] ~= nil and params.cand2index[pos_content] ~= nil then
				...
				table.insert(tensors, {tensor, params.cand2index[pos_content], params.cand2index[neg_content], 1, ug_count})
				table.insert(tensors, {tensor, params.cand2index[neg_content], params.cand2index[pos_content], 2, ug_count})
			end
